...
/requesting-code-review /writing-plans Aplikacja działa poprawnie, ale przeanalizuj dokładnie kod dashboard i demona pod katem:
...
- spójnosci wersji Windows i Mac OS
 możliwych optymalizacji, nadmiarowego kodu i sugerowanych rozwiązań oraz brakujących tłumaczeń oraz funkcjonalności nie opisanej w zakładkach help/pomoc. Swoje uwagi i szczególowe poprawki zapisz w raport.md
