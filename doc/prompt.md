...
### 7.1 Po ręcznym przypisaniu sesji do projektu wskaznik/status nieprzypisanych sesji nie zmienia się od razu - to powinno się dziać natychmiast po przypisaniu sesji do projektu.
