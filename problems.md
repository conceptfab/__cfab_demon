...
## 3. Brak synchronizacji komentarzy i słaba widoczność ikonki komentarza

**Opis:**
Występuje problem z synchronizacją komentarzy między komponentami systemu. Dodatkowo, ikona sygnalizująca dodany komentarz w widoku sesji jest zbyt mało wyraźna, co utrudnia szybką identyfikację opisanych aktywności.
