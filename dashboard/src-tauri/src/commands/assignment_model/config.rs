...
pub const DEFAULT_MIN_CONFIDENCE_SUGGEST: f64 = 0.50;
...
pub const DEFAULT_FEEDBACK_WEIGHT: f64 = 3.0;
pub const MIN_TRAINING_HORIZON_DAYS: i64 = 30;
pub const MAX_TRAINING_HORIZON_DAYS: i64 = 730;
pub const DEFAULT_TRAINING_HORIZON_DAYS: i64 = 365;
pub const DEFAULT_DECAY_HALF_LIFE_DAYS: i64 = 60;
