      ...
      <DialogContent className="max-w-xl max-h-[80vh] overflow-auto">
        ...
        {edit ? (
          ...
          <div className="grid gap-3">
            <div>
              <label htmlFor="pm-template-name" className="mb-1 block text-xs text-muted-foreground">
            ...
            <div>
              <label htmlFor="pm-template-folders" className="mb-1 block text-xs text-muted-foreground">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border bg-muted/30 text-left text-xs text-muted-foreground">
                      ...
                      <th className="px-3 py-2 font-medium text-center w-24" aria-label={t('accessibility.actions_column')} />
                    </tr>
                  </thead>
                  <tbody>
                    {templates.map((tpl) => (
