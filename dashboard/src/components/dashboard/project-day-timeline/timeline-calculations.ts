...
function computeUnionSeconds(intervals: Array<{ startMs: number; endMs: number }>): number {
...
/** Krótka etykieta osi na mobile (bez minut). */
export function fmtHourShort(ms: number): string {
