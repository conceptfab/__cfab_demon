    ...
    <div className="rounded-md border border-border/40 bg-secondary/10 p-2 text-xs">
      <div className="flex items-center gap-2">
        ...
        <select
          ...
          value={folder.badge}
          aria-label={t('projects.labels.folder_badge')}
      ...
      <div className="mt-1.5 flex items-center gap-2 pl-6">
        ...
        <input
          id={`folder-category-${folder.path}`}
          type="text"
          aria-label={t('projects.labels.folder_category')}
...
type ProjectDiscoveryPanelFlags = {
...
type ProjectDiscoveryPanelProps = {
  ...
  panelFlags: ProjectDiscoveryPanelFlags;
