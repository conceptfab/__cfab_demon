...
function DialogContent({ ref, className, children, ...props }: DialogContentProps) {
  return (
    <DialogPortal>
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-2 top-2 flex size-11 items-center justify-center rounded-[4px] opacity-70 transition-colors hover:bg-accent/80 hover:opacity-100 focus:outline-none sm:right-3 sm:top-3 sm:size-auto sm:p-1">
