...
import { cn, formatDurationWithDaily, formatMoney } from '@/lib/utils';
            ...
            {(
              ...
              >
                ...
                <div className="flex items-center justify-between text-2xl font-light">
                  ...
                  {Icon && value > 0 && (
                    <span
                      className={`inline-flex size-6 items-center justify-center rounded ${iconBg} ${iconText}`}
                    >
            ...
            {extraInfo?.top_apps.map((app) => (
              ...
              >
                ...
                <span className="shrink-0 font-mono text-xs text-emerald-400">
                  {formatDurationWithDaily(app.seconds, app.daily_seconds)}
                </span>
              </div>
            ))}
