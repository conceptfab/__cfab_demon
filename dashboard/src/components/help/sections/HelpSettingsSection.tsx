  ...
  return (
    <SectionHelp
      ...
      features={[
        ...
        t18n('help_page.time_algorithm_tab_choose_how_tracked_time_is_computed'),
        ...
        t18n('help_page.webserver_settings_feature'),
    ...
    >
      ...
      />
      <HelpDetailsBlock
        title={t18n('help_page.rounding_detail_title')}
        items={[
          t18n('help_page.rounding_detail_what_it_does'),
          t18n('help_page.rounding_detail_when_to_use'),
