  ...
  return (
    <SectionHelp
      ...
      features={[
        ...
        t18n('help_page.lan_sync_scan_policy'),
        t18n('help_page.lan_sync_inbound_presence'),
        ...
        t18n('help_page.lan_sync_macos_local_network'),
        ...
        t18n('help_page.lan_sync_tray_state'),
        ...
        t18n('help_page.local_cleanup_never_touches_data_received_from_the_paired'),
      ]}
    >
      <HelpDetailsBlock
