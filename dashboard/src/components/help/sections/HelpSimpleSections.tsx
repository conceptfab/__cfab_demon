  ...
  return (
    <SectionHelp
      ...
      features={[
        ...
        t18n('help_page.dashboard_sidebar_collapse'),
        t18n('help_page.dashboard_macos_native_window_controls'),
        t18n('help_page.dashboard_mobile_navigation_drawer'),
        t18n('help_page.dashboard_mobile_timeline_tap'),
      ]}
    />
  );
}
  ...
  return (
    <SectionHelp
      ...
      features={[
        ...
        t18n('help_page.estimates_custom_range'),
...
export function HelpClientsSection() {
  const { t: t18n } = useTranslation();

  return (
    <SectionHelp
      icon={<Users className="size-6" />}
      title={t18n('help_page.clients')}
      description={t18n('help_page.clients_desc')}
      footer={t18n('help_page.key_functionalities')}
      features={[
        t18n('help_page.clients_feature_summary'),
        t18n('help_page.clients_feature_cards'),
        t18n('help_page.clients_feature_empty'),
        t18n('help_page.clients_feature_status'),
        t18n('help_page.clients_feature_sync'),
        t18n('help_page.clients_feature_manage'),
        t18n('help_page.clients_feature_currency'),
      ]}
    />
  );
}
  ...
  return (
    <SectionHelp
      ...
      features={[
        ...
        t18n('help_page.monitored_drag_drop_app_onto_window_adds_with_precise_matching'),
  ...
  return (
    <SectionHelp
      ...
      features={[
        ...
        t18n('help_page.daemon_background_cpu_idle_gate'),
      ]}
    />
  );
}
