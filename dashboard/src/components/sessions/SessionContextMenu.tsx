...
export function SessionContextMenu({
  ...
  return (
    <div
      ref={menuRef}
      className="fixed z-50 w-[min(22rem,calc(100vw-1rem))] min-w-[240px] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95 sm:w-auto"
      style={{
