...
export const getMergedProjects = (dateRange?: DateRange) =>
  invoke<ProjectWithStats[]>('get_merged_projects', { dateRange });
...
export const mergeProject = (sourceId: number, targetId: number) =>
  invokeMutation<void>('merge_project', { sourceId, targetId });

export const unmergeProject = (id: number) =>
  invokeMutation<void>('unmerge_project', { id });
