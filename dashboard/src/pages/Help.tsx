...
import { HelpTabTrigger } from '@/components/help/HelpTabTrigger';
...
export function Help() {
  ...
  return (
    <div className="mx-auto flex h-full max-w-6xl flex-col gap-y-6 overflow-y-auto p-4 sm:p-6 md:gap-y-8 md:p-8">
      <div className="flex min-w-0 flex-col items-center justify-between gap-4 border-b border-border/10 pb-6 text-center md:flex-row md:items-end md:text-left">
        <div className="min-w-0 space-y-3">
          <div className="flex flex-col items-center gap-2 md:hidden">
            <span className="text-sm font-light tracking-[0.12em] text-muted-foreground">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              />
              <span className="text-2xl font-semibold tracking-[0.16em] text-foreground/90">
                TIMEFLOW
              </span>
            </div>
            {version && (
              <span className="text-sm font-medium tracking-normal text-muted-foreground/70 antialiased">
                β v{version}
              </span>
            )}
          </div>
          <h1 className="hidden min-w-0 flex-wrap items-center justify-center gap-2 text-xl font-light tracking-[0.04em] sm:gap-3 sm:text-3xl sm:tracking-[0.1em] md:flex md:justify-start">
            {t18n('help_page.welcome_to')}{' '}
            <div className="flex min-w-0 flex-wrap items-center justify-center gap-2 sm:ml-1 sm:gap-4 md:justify-start">
              <img
                src={logo}
                alt="TIMEFLOW"
                className="size-9 object-contain sm:size-11"
              />
              <span className="font-semibold tracking-[0.12em] sm:tracking-[0.2em]">TIMEFLOW</span>
            </div>
            {version && (
              <span className="w-full text-sm font-medium tracking-normal text-muted-foreground/70 antialiased sm:mb-1 sm:w-auto sm:self-end sm:ml-2">
                β v{version}
              </span>
            )}
          </h1>
          <div className="mt-1 flex flex-wrap items-center justify-center gap-2 text-[11px] tracking-wide text-muted-foreground/70 md:ml-1 md:justify-start">
      ...
      <div className="space-y-4 pt-4">
        ...
        >
          ...
          <div className="w-full min-w-0 flex-1 pt-6 md:pl-10 md:pt-0">
            ...
            <TabsContent value="webserver" className="m-0 focus-visible:outline-none">
              <HelpWebServerSection />
            </TabsContent>
